...
A2A 协议支持 LibreFang Agent 之间的通信。
...
```bash
curl -X POST http://localhost:4545/a2a/tasks \
...
```bash
# 轮询
curl http://localhost:4545/a2a/tasks/task-123

# 或使用 SSE
curl -N http://localhost:4545/a2a/tasks/task-123/events
```
