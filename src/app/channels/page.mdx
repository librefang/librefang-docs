...
Since [PR #223](https://github.com/librefang/librefang/pull/223), each channel adapter is gated behind a Cargo feature flag for smaller binary sizes.
...
See the [examples/custom-channel/](https://github.com/librefang/librefang/tree/main/examples/custom-channel) directory in the main repo for a reference template.
