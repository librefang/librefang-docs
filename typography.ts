			...
			DEFAULT: {
				css: {
					...
					h1: {
						...
						fontWeight: '700',
						fontSize: (theme('fontSize.2xl') as string[])[0],
					...
					h2: {
						color: 'var(--tw-prose-headings)',
						fontWeight: '600',
						fontSize: (theme('fontSize.lg') as string[])[0],
					...
					figcaption: {
						...
						fontSize: (theme('fontSize.xs') as string[])[0],
					...
					code: {
						...
						fontSize: (theme('fontSize.2xs') as string[])[0],
					},
